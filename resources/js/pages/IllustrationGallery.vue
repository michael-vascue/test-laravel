    ...
    <div class="container">
        <div class="d-flex">
            <div class="col-7 m-0 p-0">
                <form class="search text" action="#" style="max-width:500px; min-width:300px">
                        <input type="text" placeholder="Search..." name="search2">
                        <button type="submit"><i class="fa fa-search fa-lg"></i></button>
                </form>
            </div>
            <div class="d-flex col-5 justify-content-end m-0 p-0">
                <div class="selectwrap">
                    <select class="custom-select text2 " aria-label="Default select example">
                        <option class="mx-auto" value="1" selected>All</option>
        ...
        <div style="margin-top:4rem">
            <div class="card" style="width: 20rem;height: 20rem" :style="{card:color}">
                <div class="card-body">
                    <h5 class="card-title text2" :style="{color:color}">Card title</h5>
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 336.09 293.69" width="406" height="306" class="center illustration styles_illustrationTablet__1DWOa">
                        <defs>
                            <linearGradient id="linear-gradient" x1="206.31" y1="149.8" x2="221.17" y2="23.52" gradientTransform="matrix(1, 0, 0, -1, -49.39, 315.31)" gradientUnits="userSpaceOnUse"><stop offset="0.01"></stop><stop offset="0.08" stop-opacity="0.69"></stop><stop offset="0.21" stop-opacity="0.32"></stop><stop offset="1" stop-opacity="0"></stop></linearGradient>
                            ...
                            <linearGradient id="linear-gradient-6" x1="106.29" y1="184.51" x2="175.79" y2="106.92" gradientTransform="matrix(1, 0, 0, -1, 0, 352)" gradientUnits="userSpaceOnUse"><stop offset="0.01"></stop><stop offset="0.13" stop-opacity="0.69"></stop><stop offset="0.25" stop-opacity="0.32"></stop><stop offset="1" stop-opacity="0"></stop></linearGradient>
                            <linearGradient id="linear-gradient-7" x1="124" y1="189.11" x2="134.65" y2="118.54" xlink:href="#linear-gradient-6"></linearGradient>
                        </defs>
                        <title>11</title>
                            <path d="M172.59,46.08c-41.25,15.15-75.92,47.2-88.45,85.16-3.6,10.92-5.53,22.18-9.7,33-4.64,12-12,23.21-17.09,35.1-15.43,35.75-7.69,76.59,16.77,105.44,18.43,21.73,45.68,30.41,76.76,23,15.31-3.64,28.49-11.8,43.33-16.07,20.47-5.89,43.6-5.33,64.51-5.87,23.36-.61,72.31-9,95.75-11,35.94-3.08,34.22-77.66,26.34-96.46s-20.16-35.71-29-54.13c-10.22-21.28-15.95-44.67-30.24-63.86C299.69,51,258.72,35,217.83,36.83A150.64,150.64,0,0,0,172.59,46.08Z" transform="translate(-49.39 -36.69)" :style="{fill:color}" opacity="0.18" style="isolation: isolate;"></path>
                            <ellipse cx="166.76" cy="249.14" rx="149.06" ry="15.06" fill="url(#linear-gradient)"></ellipse>
                            <polygon points="207.37 195.49 150.89 195.49 140.62 151.75 197.1 151.75 207.37 195.49" :style="{fill:color}"></polygon>
                            <polygon points="204.03 195.49 150.89 195.49 140.62 151.75 193.76 151.75 204.03 195.49" fill="url(#linear-gradient-2)"></polygon>
                            <rect x="80.77" y="193.9" width="201.42" height="53.66" :style="{fill:color}"></rect>
                            <rect x="80.77" y="193.9" width="201.42" height="53.66" fill="url(#linear-gradient-3)"></rect>
                            <rect x="66.99" y="38.44" width="199.55" height="127.08" rx="17.57" :style="{fill:color}"></rect>
                            ...
                            <path d="M189.37,197.85a1.61,1.61,0,0,1-.33-.36,1.08,1.08,0,0,1-.91.11l-1.32-.22a2.23,2.23,0,0,1-.67-.19h-.09l-.28.54a8.12,8.12,0,0,0-.83,3.09,28,28,0,0,0,7.63.73,1.17,1.17,0,0,0,1.09-.45.88.88,0,0,0,0-.71,2.12,2.12,0,0,0-1.22-1.09c-.68-.28-1.37-.52-2-.84A4.55,4.55,0,0,1,189.37,197.85Z" transform="translate(-49.39 -36.69)" :style="{fill:color}"></path>
